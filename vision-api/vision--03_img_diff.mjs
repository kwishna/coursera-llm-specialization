    ...
    messages: [
      {
        ...
        "You should list down at least 5 differences in bullet points."
      },
      {
        role: "user",
        content: [
          ...
          },
          {
            type: "image_url",
            image_url: {
              "url": get_image_base64(resolve("./image_diff_one.PNG")),
            },
          },
          {
            type: "image_url",
            image_url: {
              "url": get_image_base64(resolve("./image_diff_two.PNG")),
            },
          },
        ],
      },
 ...
 */
function get_image_base64(image_path) {
